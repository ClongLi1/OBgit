...
// 创建时间轴
let timeline = "";
timeline += `<div style="display: flex; height: 6px; margin: 5px 0; position: relative;">`;
...
// 圆形标记
timeline += `<div style="width: 9px; height: 9px; background-color: #454AFF; transform: rotate(45deg);"></div>`;
...
// 添加月份标签
timeline += `<div style="display: flex; justify-content: space-between; margin-top: 10px; font-size: 12px; color: #FF69B9;">`;
